...
CUDA_VISIBLE_DEVICES="$GPU_ID" python3 inference.py conf_exp/experiment12_step2.json Cube challenge data/cube/challenge.txt $TRAINED_MODEL_PATH/Cube/plus/kmeans_finalaffine_notrain_k25/0/model_best.pth.tar -gpu 0 --outputfolder $TRAINED_MODEL_PATH/cube_test/
